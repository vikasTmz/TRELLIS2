...
if __name__ == "__main__":
    ...
    print(f"Total {len(metadata)} objects to process.")
    ...
    # process objects
    downloaded = dataset_utils.download(metadata, opt.download_root, **opt)
    downloaded.to_csv(
        os.path.join(opt.download_root, "raw", "new_records", f"part_{opt.rank}.csv"),
        index=False,
    )
